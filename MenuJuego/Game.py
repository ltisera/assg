...
pygame.mixer.music.load("Recursos/Musica/nivel1.wav")
...
while intro:
	...
	pantalla.display.blit(texto2, (665,65))
	pantalla.display.blit(texto3, (665,85))
	pantalla.display.blit(texto4, (30,500))
	pantalla.display.blit(texto5, (30,520))
